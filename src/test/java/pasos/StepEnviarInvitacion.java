...
public class StepEnviarInvitacion {
	...
	public void crearReunion(int idReunion, String titulo, String descripcion, LocalDate horaInicio, LocalDate horaFin, Usuario organizador, List <Usuario>asistentes, String url) throws Exception {
